...
class CreateSimulatedPlaneRequest(roslib.message.Message):
  _md5sum = "c3c00052be2469bc449553cc4298eb1d"
...
int64 startingGroundSpeed
int64 startingBearing

"""
  __slots__ = ['startingLatitude','startingLongitude','startingAltitude','startingGroundSpeed','startingBearing']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       startingLatitude,startingLongitude,startingAltitude,startingGroundSpeed,startingBearing
    ...
    if args or kwds:
      ...
      if self.startingGroundSpeed is None:
        self.startingGroundSpeed = 0
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3d2q.pack(_x.startingLatitude, _x.startingLongitude, _x.startingAltitude, _x.startingGroundSpeed, _x.startingBearing))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.startingLatitude, _x.startingLongitude, _x.startingAltitude, _x.startingGroundSpeed, _x.startingBearing,) = _struct_3d2q.unpack(str[start:end])
      return self
...
_struct_3d2q = struct.Struct("<3d2q")
...
class CreateSimulatedPlane(roslib.message.ServiceDefinition):
  ...
  _md5sum = 'c562b6278ce122f33fe645ad5dfdb1b7'
