...
void decode_gps(void)
{
	...
	if (numc > 0){
		for (int i=0;i<numc;i++){	// Process bytes received
			data = Serial.read();
                        //Serial.println(data, HEX); //debugging to receive each byte
			...
			case 0:	
				...
				//else{
				//	Serial.print("IMU parser Case 0 fail");	 // This line for debugging only
			...
			case 1:	
				...
				//	Serial.print("IMU parser Case 1 fail");
                                //        Serial.println(data, HEX);	 
